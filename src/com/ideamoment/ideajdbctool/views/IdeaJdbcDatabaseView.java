package com.ideamoment.ideajdbctool.views;
...
import com.ideamoment.ideajdbctool.database.Tbl;
import com.ideamoment.ideajdbctool.dialogs.ConnectionDialog;
import com.ideamoment.ideajdbctool.editors.ClauseEditorInput;
...
public class IdeaJdbcDatabaseView extends ViewPart {
	 ...
	 */
	public static final String ID = "com.ideamoment.ideajdbctool.views.IdeaJdbcDatabaseView";
 ...
 */
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "com.ideamoment.ideajdbctool.views.IdeaJdbcDatabaseView");
		makeActions();
		hookContextMenu();
			...
			public void run() {
				...
				if(obj.getClass().getName().indexOf("TreeObject") > -1) {
					...
					if(editor != null) {
						...
						try {
							workbenchPage.openEditor(editorInput, "com.ideamoment.ideajdbctool.editors.ClauseEditor");
